...
function Footer() {
  return (
    <div className='w-full h-screen p-20 flex bg-zinc-900 gap-5'>
        <div className='w-1/2 h-full flex flex-col justify-between'>

            <div className='heading'>
            <h1 className='text-[6vw] font-semibold leading-none tracking-tighter'>EYE-</h1>
            <h1 className='text-[6vw] font-semibold leading-none tracking-tighter'>OPENING</h1>
            </div>
        ...
        <div className="Email mt-10">
          ...
          <div>
          <div className="Menu mt-[11.5rem]">
            <h4 className='pb-4'>Menu:</h4>
            ...
            <a className='block underline' href="#">Contact</a>
        </div>
          </div>
        </div>
        </div>
